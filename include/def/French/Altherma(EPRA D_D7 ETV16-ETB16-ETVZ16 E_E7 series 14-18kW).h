...
{0x62,8,307,1,-1,"Retour pompe (bit7)"},
{0x62,8,306,1,-1,"Retour pompe (bit6)"},
{0x62,8,305,1,-1,"Retour pompe (bit5)"},
...
{0x63,8,105,2,1,"[HPSU] Temp. eau depart mixte apres ballon R7T"},
{0x63,10,101,1,-1,"[HPSU] Position vanne ballon (0:bypass 100:ballon)"},
{0x63,11,101,1,-1,"[HPSU] Position vanne bypass (0:bypass 100:emetteur)"},
