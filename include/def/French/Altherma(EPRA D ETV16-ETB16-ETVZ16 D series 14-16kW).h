...
{0x10,1,307,1,-1,"Thermostat 1 ON/OFF"},
...
{0x60,2,303,1,-1,"Thermostat 2 ON/OFF"},
...
{0x63,8,105,2,1,"[HPSU] Température sortie eau mélangée après ballon R7T (DLWA2)"},
{0x63,10,101,1,-1,"[HPSU] Position vanne réservoir (0:Bypass 100:Reservoir)"},
{0x63,11,101,1,-1,"[HPSU] Position vanne de dérivation (0:Bypass 100:Emettrice)"},
{0x63,12,323,1,-1,"[HPSU] Etat du réservoir (1:Préchauffage 2:Support 3:excès)"},
{0x63,12,305,1,-1,"[HPSU] Signal de sortie bivalent ballon ECS"},
{0x63,12,304,1,-1,"[HPSU] Réservoir ECS source de chaleur primaire bivalente (OFF:HP  ON:Chaudière)"},
{0x63,12,303,1,-1,"[HPSU] Signal de sortie bivalent pour le chauffage du ballon"},
{0x63,12,302,1,-1,"[HPSU] Chauffage du réservoir source de chaleur primaire bivalente (OFF:HP  ON:Chaudière)"},
